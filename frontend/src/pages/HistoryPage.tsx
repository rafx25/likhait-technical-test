...
const HistoryPage: React.FC = () => {
  ...
  // Load the category list once on mount so the expense form and the
  // "Add Category" flow stay in sync with the backend.
  useEffect(() => {
    loadCategories();
  }, []);
  ...
  const handleAddCategory = async (name: string) => {
    // Let errors bubble up so the form can display the backend message
    // (e.g. duplicate name); only close/refresh on success.
